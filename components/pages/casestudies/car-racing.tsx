      ...
      <main>
        ...
        <div className="cs-wrap">
          ...
          <section className="cs-section" id="sec-design">
            ...
            <p className="cs-body">
              The six cars are tuned so odds, stats and drama line up: the favourite <strong className="cs-gold">Thunder Strike</strong> sits at 2.5× with high speed, while the long shot <strong className="cs-gold">Blue Thunder</strong> pays 12× - a bigger gamble with weaker odds. A 60% speed / 40% handling weighting decides the baseline, and the per-tick jitter is what creates the lead-changes that make a race worth watching.
            </p>
              ...
              <div className="sg-unit">
                <div className="glass-box">
                  ...
                  <div className="color-strip">
                    <div className="color-block" style={cssVars({ '--sw': '#070012' })}><span className="color-hex">#070012</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#0E001E' })}><span className="color-hex">#0E001E</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#160028' })}><span className="color-hex">#160028</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#1E0038' })}><span className="color-hex">#1E0038</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#F5EEFF' })}><span className="color-hex">#F5EEFF</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#FFFFFF' })}><span className="color-hex">#FFFFFF</span></div>
                  </div>
                  <div className="color-strip">
                    <div className="color-block" style={cssVars({ '--sw': '#FF6B00' })}><span className="color-hex">#FF6B00</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#00E5FF' })}><span className="color-hex">#00E5FF</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#FF2E7A' })}><span className="color-hex">#FF2E7A</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#00FF88' })}><span className="color-hex">#00FF88</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#A050FF' })}><span className="color-hex">#A050FF</span></div>
                    <div className="color-block" style={cssVars({ '--sw': '#FF00CC' })}><span className="color-hex">#FF00CC</span></div>
                  </div>
                </div>
              </div>
          ...
          <section className="cs-section" id="sec-results">
            ...
            <div className="cs-cta-row">
              <a href="https://game-engine-snowy.vercel.app/games/car-racing" target="_blank"
