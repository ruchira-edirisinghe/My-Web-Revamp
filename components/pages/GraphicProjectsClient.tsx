...
const GALLERIES: GalleryCard[] = [
  { type: 'type-design', idx: 0, img: '/Images/projects/4.png', alt: 'Logo Designs', label: 'Identity Design', title: 'Logo Designs', desc: 'Crafting iconic visual signatures that define brands and leave lasting impressions.', tags: ['Vector Art', 'Branding'], href: '/projects/graphic/logos', cta: 'View Gallery ↗' },
